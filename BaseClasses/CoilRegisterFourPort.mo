within CCC323_test.BaseClasses;
model CoilRegisterFourPort "Four port register for a pcm heat exchanger"
  ...
  replaceable parameter CCC323_test.Data.SunampQ6 Design "Design of HX";
  ...
  Modelica.Fluid.Interfaces.FluidPort_b port_b2(redeclare each package Medium =
    ...
    annotation (Placement(transformation(extent={{-90,-52},{-110,-32}}),
        iconTransformation(extent={{-90,-52},{-110,-32}})));
  Buildings.Fluid.Sensors.MassFlowRate senMasFloHPC(redeclare package Medium =
        Medium)
    annotation (Placement(transformation(extent={{-48,42},{-32,58}})));
  Buildings.Fluid.Sensors.MassFlowRate senMasFloLPC(redeclare package Medium =
        Medium)
